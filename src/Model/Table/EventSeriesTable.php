 ...
 * @method \App\Model\Entity\EventSeries findOrCreate(\Cake\ORM\Query\SelectQuery|callable|array $search, ?callable $callback = null, array $options = [])
 *
 ...
 * @method \App\Model\Entity\EventSeries[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventSeries>|false saveMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventSeries[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventSeries> saveManyOrFail(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventSeries[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventSeries>|false deleteMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventSeries[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventSeries> deleteManyOrFail(iterable $entities, array $options = [])
