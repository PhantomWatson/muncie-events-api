 ...
 * @method \App\Model\Entity\MailingList findOrCreate(\Cake\ORM\Query\SelectQuery|callable|array $search, ?callable $callback = null, array $options = [])
 *
 * @mixin TimestampBehavior
 * @method \App\Model\Entity\MailingList newEmptyEntity()
 * @method \App\Model\Entity\MailingList[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\MailingList>|false saveMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\MailingList[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\MailingList> saveManyOrFail(iterable $entities, array $options = [])
 * @method \App\Model\Entity\MailingList[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\MailingList>|false deleteMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\MailingList[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\MailingList> deleteManyOrFail(iterable $entities, array $options = [])
