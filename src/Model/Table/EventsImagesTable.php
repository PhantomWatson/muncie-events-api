 ...
 * @method \App\Model\Entity\EventsImage findOrCreate(\Cake\ORM\Query\SelectQuery|callable|array $search, ?callable $callback = null, array $options = [])
 *
 ...
 * @method \App\Model\Entity\EventsImage[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventsImage>|false saveMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventsImage[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventsImage> saveManyOrFail(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventsImage[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventsImage>|false deleteMany(iterable $entities, array $options = [])
 * @method \App\Model\Entity\EventsImage[]|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\EventsImage> deleteManyOrFail(iterable $entities, array $options = [])
